...
namespace FormulaTester
{
    ...
    public class FormulaTester
    {
		...
		/// <summary>
		/// This is testing my XML file cuz i have no idea whats goin on
		/// </summary>
		[TestMethod]
		...
		// these tests below caused my tester to break for some reason. Please
		// remove the /* at the top and */ at the bottom and try these tests
		// in yours?
		...
		/// </summary>
		[TestMethod]
		public void Public_Test_NotEquals_Method_1()
		{
			Assert.IsFalse(new Formula("4.2 - 8 + y7", s => s.ToUpper(), x => true) != new Formula("4.2-8.0+y7"));
		}
		...
		/// </summary>
		[TestMethod]
		public void Public_Test_NotEquals_Method_2()
		{
			Assert.IsTrue(new Formula("4.2 - 8 + y7", s => s.ToUpper(), x => true) != new Formula("4.2-8.0+Y7"));
		}
		...
		/// </summary>
		[TestMethod]
		public void Public_Test_HashCode_Method_1()
		{
			Assert.AreEqual(new Formula("4.2 - 8 + y7", s => s.ToUpper(), x => true).GetHashCode(), new Formula("4.2-8.0+Y7").GetHashCode());
		}*/
