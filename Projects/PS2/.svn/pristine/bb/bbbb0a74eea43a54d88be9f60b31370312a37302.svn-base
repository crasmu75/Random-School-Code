...
namespace PS2GradingTests
{
    ...
    public class DependencyGraphTest
    {
        ...
        // ********************************** MY OWN TESTS ADDED ******************** //
        ///<summary>
        ///Adding and deleting consistently
        ///</summary>
        [TestMethod()]
        public void CamilleTest1()
        {
            DependencyGraph t = new DependencyGraph();
            t.AddDependency("a", "b");
            t.AddDependency("c", "d");
        ...
        ///<summary>
        ///Non-empty graph, removing dependency that doesn't exist
        ///</summary>
        [TestMethod()]
        public void CamilleTest2()
        {
            DependencyGraph t = new DependencyGraph();
            t.AddDependency("f", "b");
            t.AddDependency("i", "g");
            t.RemoveDependency("t", "w");
            Assert.AreEqual(2, t.Size);
        }

        ///<summary>
        ///Testing indexer on valid and invalid
        ///</summary>
        [TestMethod()]
        public void CamilleTest3()
        {
            DependencyGraph t = new DependencyGraph();
            t.AddDependency("a", "b");
            t.AddDependency("b", "c");
            ...
            Assert.AreEqual(2, t["c"]);
            Assert.AreEqual(0, t["a"]);
            Assert.AreEqual(0, t["yellow"]);
        }

        ///<summary>
        ///HasDependents and HasDependees on empty
        ///</summary>
        [TestMethod()]
        public void CamilleTest4()
        {
            DependencyGraph t = new DependencyGraph();
            Assert.IsFalse( t.HasDependents("you"));
            Assert.IsFalse( t.HasDependees("you"));
        }

        ///<summary>
        ///HasDependents on doesn't exist (NonEmptyTest3 does not test this)
        ///</summary>
        [TestMethod()]
        public void CamilleTest5()
        {
            DependencyGraph t = new DependencyGraph();
            t.AddDependency("a", "b");
            t.AddDependency("a", "c");
        ...
        ///<summary>
        ///Replace dependents of a dependee that is not in list
        ///</summary>
        [TestMethod()]
        public void CamilleTest6()
        {
            DependencyGraph t = new DependencyGraph();
            t.AddDependency("j", "b");
            t.AddDependency("i", "c");
        ...
        ///<summary>
        ///Replace dependees of a dependent that is not in list
        ///</summary>
        [TestMethod()]
        public void CamilleTest7()
        {
            DependencyGraph t = new DependencyGraph();
            t.AddDependency("j", "b");
            t.AddDependency("i", "c");
            t.AddDependency("d", "c");
            t.ReplaceDependees("q", new HashSet<string>() { "x", "y", "z" });
            HashSet<String> cDees = new HashSet<string>(t.GetDependees("q"));
            Assert.IsTrue(cDees.SetEquals(new HashSet<string>() { "x", "y", "z" }));
        }
    }
}
